...
def main():
	...
	users_info = data_manager.get_usernames_and_emails(params=None)
	...
	for city in sheet_data["prices"]:
		...
		flight_search_results = flight_search.get_flights(my_destination="Belgrade", desired_destination=city_param)
